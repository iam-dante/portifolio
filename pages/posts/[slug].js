...
const MarkdownComponents = {
  ...
  h3: (props) => (
    <h3 className="text-2xl font-bold text-black mt-5 mb-2" {...props} />
  ),
  ...
  ul: (props) => (
    <ul className="list-disc list-inside text-black mb-4 ml-4" {...props} />
  ),
  ol: (props) => (
    <ol
      className="list-decimal list-inside text-black mb-4 ml-4"
      {...props}
    />
  ),
  ...
  blockquote: (props) => (
    <blockquote
      className="border-l-4  pl-4 italic text-black my-4"
      {...props}
    />
  ),
  code: ({ node, inline, className, children, ...props }) => {
    ...
    return !inline && match ? (
      ...
      <code className="bg-red-400  rounded text-sm" {...props}>
        {children}
      </code>
    );
  },
      ...
      <PostLayout>
        ...
        <ReactMarkdown
          ...
          rehypePlugins={[
            ...
            [rehypeHighlight, { ignoreMissing: false }], // Syntax highlighting
          ]}
        >
          {content}
        </ReactMarkdown>
